...
export default function MedicineCreateForm({ setMedicines, BASE_URL }) {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    try {
      ...
      const responseLocation = await axios.get(`https://pharmacy-app.onrender.com/api/map`, {
        headers: {
          'Content-Type': 'application/json',
        },
        Authorization: `Bearer ${token}`,
      ...
      const responseStock = await axios.post(`https://pharmacy-app.onrender.com/api/stock`, stockItems, {
        headers: {
          'Content-Type': 'application/json',
        },
        Authorization: `Bearer ${token}`,
