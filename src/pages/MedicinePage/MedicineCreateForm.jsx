...
export default function MedicineCreateForm({ setMedicines, BASE_URL }) {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    try {
      const responseMedicine = await axios.post(`${import.meta.env.VITE_APP_BACK_END_URL}/api/medicine`, values, {
        headers: {
      ...
      const responseLocation = await axios.get(`${import.meta.env.VITE_APP_BACK_END_URL}/api/map`, {
        headers: {
          'Content-Type': 'application/json',
        },
        Authorization: `Bearer ${token}`,
      ...
      const responseStock = await axios.post(`${import.meta.env.VITE_APP_BACK_END_URL}/api/stock`, stockItems, {
        headers: {
          'Content-Type': 'application/json',
        },
        Authorization: `Bearer ${token}`,
