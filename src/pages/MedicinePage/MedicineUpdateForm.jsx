...
export default function MedicineUpdateForm({BASE_URL}) {
    ...
    useEffect(() => {
        const fetchMedicine = async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_APP_BACK_END_URL}/api/medicine/${id}`);
  ...
  const handleFormSubmit = async (e, values) => {
    ...
    try {
      const response = await axios.put(`${import.meta.env.VITE_APP_BACK_END_URL}/api/medicine/${id}`, medicine, {
        headers: {
