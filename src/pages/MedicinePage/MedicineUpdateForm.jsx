...
export default function MedicineUpdateForm({BASE_URL}) {
    ...
    useEffect(() => {
        const fetchMedicine = async () => {
            try {
                const response = await axios.get(`${process.env.BACK_END_URL}/api/medicine/${id}`);
  ...
  const handleFormSubmit = async (e, values) => {
    ...
    try {
      const response = await axios.put(`${process.env.BACK_END_URL}/api/medicine/${id}`, medicine, {
        headers: {
