...
export default function MedicineUpdateForm({BASE_URL}) {
    ...
    useEffect(() => {
        const fetchMedicine = async () => {
            try {
                const response = await axios.get(`https://pharmacy-app.onrender.com:10000/api/medicine/${id}`);
  ...
  const handleFormSubmit = async (e, values) => {
    ...
    try {
      const response = await axios.put(`https://pharmacy-app.onrender.com/api/medicine/${id}`, medicine, {
        headers: {
