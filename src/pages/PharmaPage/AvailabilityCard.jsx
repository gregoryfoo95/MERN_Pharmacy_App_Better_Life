...
export default function AvailabilityCard() {
    ...
    useEffect(() => {
        ...
        async function fetchLocations() {
            try {
                const response = await axios.get(`${BASE_URL_MAP}`);
    ...
    return (
        <>
            ...
            <button onClick={handleAvailClick}>Toggle Availability</button>
            ...
            {locations.length > 0 ? (
             ...
             <button onClick={handleLocClick}>Save Location</button>
        </>
    )
}