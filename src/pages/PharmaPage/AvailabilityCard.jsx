...
export default function AvailabilityCard() {
  ...
  useEffect(() => {
    async function fetchUser() {
      try {
        const response = await axios.get(`${import.meta.env.VITE_APP_BACK_END_URL}/api/user/${user._id}`);
    ...
    async function fetchLocations() {
      try {
        const response = await axios.get(`${import.meta.env.VITE_APP_BACK_END_URL}/api/map`);
  ...
  const handleAvailClick = async e => {
    ...
    try {
      ...
      const response = await axios.put(`${import.meta.env.VITE_APP_BACK_END_URL}/api/user/${user._id}`, newUser, {
        headers: {
