...
/* const generateToken = (id) => {
  return jwt.sign({ id }, import.meta.env.VITE_APP_JWT_SECRET, { expiresIn: "1d" });
}; */
...
const create = async (req, res) => {
  ...
  try {
    ...
    const payload = { user };
    const token = jwt.sign(payload, import.meta.env.VITE_APP_JWT_SECRET,{ expiresIn: 3600});
...
const forgotPassword = asyncHandler(async (req, res) => {
  ...
  // Construct Reset Url
  const resetUrl = `${import.meta.env.FRONTEND_URL}/resetpassword/${resetToken}`;
